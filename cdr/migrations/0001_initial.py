# Generated by Django 5.0.7 on 2024-09-14 07:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_id', models.CharField(blank=True, db_comment='父诊断唯一标识', max_length=36, null=True, verbose_name='父诊断唯一标识')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adm_cls_code', models.PositiveSmallIntegerField(choices=[(1, '门诊'), (2, '急诊'), (3, '住院'), (4, '体检'), (9, '其他')], db_comment='就诊类别代码', verbose_name='就诊类别代码')),
                ('gmt_adm', models.DateTimeField(blank=True, db_comment='入院日期时间', null=True, verbose_name='入院日期时间')),
                ('gmt_discharge', models.DateTimeField(blank=True, db_comment='出院日期时间', null=True, verbose_name='出院日期时间')),
                ('reason', models.CharField(blank=True, db_comment='就诊原因', max_length=128, null=True, verbose_name='就诊原因')),
                ('patient_id', models.CharField(db_comment='患者唯一标识ID', max_length=36, verbose_name='患者唯一标识ID')),
                ...
                ('dept_id', models.CharField(db_comment='出院科室id', max_length=36, verbose_name='出院科室id')),
                ('dept_name', models.CharField(db_comment='出院科室名称', max_length=64, verbose_name='出院科室名称')),
                ('ward_id', models.CharField(db_comment='出院病区id', max_length=36, verbose_name='出院病区id')),
                ('ward_name', models.CharField(db_comment='出院病区名称', max_length=64, verbose_name='出院病区名称')),
                ('room_id', models.CharField(db_comment='病房id', max_length=36, verbose_name='病房id')),
                ('room_name', models.CharField(db_comment='病房名称', max_length=64, verbose_name='病房名称')),
                ('bed_id', models.CharField(db_comment='床号ID', max_length=36, verbose_name='床号ID')),
                ('bed_name', models.CharField(db_comment='床号', max_length=64, verbose_name='床号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_sign', models.TextField(blank=True, db_comment='申请单开立者签名', null=True, verbose_name='申请单开立者签名')),
                ...
                ('method_code', models.CharField(blank=True, db_comment='检验方法编码', max_length=36, null=True, verbose_name='检验方法编码')),
                ...
                ('from_src', models.CharField(db_comment='来源系统', max_length=36, verbose_name='来源系统')),
                ('gmt_created', models.DateTimeField(auto_now_add=True, db_comment='系统记录时间', verbose_name='系统记录时间')),
                ('extra', models.JSONField(db_comment='补充信息', db_default='{}', default=dict, verbose_name='补充信息, 就诊流水号')),
            ],
            options={
                'verbose_name': '检验申请信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_code', models.CharField(choices=[('01', '择期'), ('02', '围期')], db_comment='手术性质编码（择期，围期)', max_length=2, verbose_name='手术性质编码')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_sign', models.TextField(blank=True, db_comment='医嘱开立者签名', null=True, verbose_name='医嘱开立者签名')),
                ...
                ('dose', models.DecimalField(db_comment='用药剂量-单次', decimal_places=4, max_digits=8, verbose_name='用药剂量-单次')),
                ('dose_unit', models.CharField(blank=True, db_comment='用药剂量-单次-单位', max_length=36, null=True, verbose_name='用药剂量-单次-单位')),
                ('dose_total', models.DecimalField(db_comment='药物使用总剂量', decimal_places=4, max_digits=8, verbose_name='药物使用总剂量')),
                ...
                ('execute_dept_id', models.CharField(blank=True, db_comment='执行科室编码', max_length=36, null=True, verbose_name='执行科室编码')),
                ('execute_dept_name', models.CharField(blank=True, db_comment='执行科室名称', max_length=64, null=True, verbose_name='执行科室名称')),
                ('pre_order_id', models.CharField(blank=True, db_comment='父医嘱ID', help_text='没有父医嘱可以没有此occurrenceOf节点', max_length=36, null=True, verbose_name='父医嘱ID')),
                ('order_cls_code', models.PositiveSmallIntegerField(choices=[(1, '长期医嘱'), (2, '临时医嘱'), (9, '其他')], db_comment='医嘱类别编码', verbose_name='医嘱类别编码')),
                ('amount', models.DecimalField(db_comment='领量(给药量)', decimal_places=4, max_digits=8, verbose_name='领量(给药量)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_name', models.CharField(db_comment='责任医师姓名', max_length=32, verbose_name='责任医师姓名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_code', models.PositiveSmallIntegerField(choices=[(1, '预约成功'), (0, '取消预约')], db_comment='预约状态代码', verbose_name='预约状态代码')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra', models.JSONField(blank=True, db_comment='补充信息', null=True, verbose_name='补充信息')),
                ('from_src', models.CharField(db_comment='来源系统', max_length=36, verbose_name='来源系统')),
                ('gmt_created', models.DateTimeField(auto_now_add=True, db_comment='系统记录时间', verbose_name='系统记录时间')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visit_status', models.PositiveSmallIntegerField(choices=[(1, '分诊台分诊'), (2, '医生开始接诊'), (3, '医生结束接诊'), (4, '转诊')], verbose_name='就诊状态')),
        ...
        migrations.AddConstraint(
            model_name='check',
            constraint=models.UniqueConstraint(fields=('apply_no', 'item_code'), name='unique_apply_no_item_code_check'),
        ),
        migrations.AddIndex(
            model_name='checkappointstatus',
            index=models.Index(fields=['order_id'], name='cdr_checkap_order_i_828452_idx'),
        ),
        migrations.AddIndex(
            model_name='checkappointstatus',
            index=models.Index(fields=['apply_no'], name='cdr_checkap_apply_n_c856f2_idx'),
        ),
        migrations.AddIndex(
            model_name='checkappointstatus',
            index=models.Index(fields=['adm_no'], name='cdr_checkap_adm_no_337c05_idx'),
        ),
        migrations.AddIndex(
            model_name='checkappointstatus',
            index=models.Index(fields=['patient_id'], name='cdr_checkap_patient_89d6b9_idx'),
        ),
        migrations.AddIndex(
            model_name='checkreport',
            index=models.Index(fields=['patient_id'], name='cdr_checkre_patient_3265a2_idx'),
        ),
        migrations.AddIndex(
            model_name='checkreport',
            index=models.Index(fields=['adm_no'], name='cdr_checkre_adm_no_255cea_idx'),
        ),
        migrations.AddIndex(
            model_name='checkstatus',
            index=models.Index(fields=['apply_no'], name='cdr_checkst_apply_n_57f02a_idx'),
        ),
        migrations.AddIndex(
            model_name='checkstatus',
            index=models.Index(fields=['adm_no'], name='cdr_checkst_adm_no_4c43ac_idx'),
        ),
        migrations.AddIndex(
            model_name='checkstatus',
            index=models.Index(fields=['patient_id'], name='cdr_checkst_patient_edab5c_idx'),
        ),
        migrations.AddIndex(
            model_name='diagnosis',
            index=models.Index(fields=['adm_no'], name='cdr_diagnos_adm_no_6ef28f_idx'),
        ),
        migrations.AddIndex(
            model_name='diagnosis',
            index=models.Index(fields=['patient_id'], name='cdr_diagnos_patient_219216_idx'),
        ),
        migrations.AddIndex(
            model_name='discharge',
            index=models.Index(fields=['patient_id'], name='cdr_dischar_patient_1d5531_idx'),
        ),
        migrations.AddIndex(
            model_name='discharge',
            index=models.Index(fields=['adm_no'], name='cdr_dischar_adm_no_41c221_idx'),
        ),
        migrations.AddIndex(
            model_name='encountercard',
            index=models.Index(fields=['card_no'], name='cdr_encount_card_no_f2f3d7_idx'),
        ),
        migrations.AddIndex(
            model_name='encountercard',
            index=models.Index(fields=['id_no'], name='cdr_encount_id_no_5f527c_idx'),
        ),
        migrations.AddIndex(
            model_name='encountercard',
            index=models.Index(fields=['tel_no'], name='cdr_encount_tel_no_fec101_idx'),
        ),
        migrations.AddIndex(
            model_name='exam',
            index=models.Index(fields=['patient_id'], name='cdr_exam_patient_31992b_idx'),
        ),
        migrations.AddConstraint(
            model_name='exam',
            constraint=models.UniqueConstraint(fields=('apply_no', 'item_code'), name='unique_apply_no_item_code_exam'),
        ),
        migrations.AddIndex(
            model_name='examreport',
            index=models.Index(fields=['adm_no'], name='cdr_examrep_adm_no_cab652_idx'),
        ),
        migrations.AddIndex(
            model_name='examreport',
            index=models.Index(fields=['patient_id'], name='cdr_examrep_patient_d5b9da_idx'),
        ),
        migrations.AddIndex(
            model_name='examresultdetail',
            index=models.Index(fields=['exam_result_main_id'], name='cdr_examres_exam_re_ced6d1_idx'),
        ),
        migrations.AddConstraint(
            model_name='examresultdetail',
