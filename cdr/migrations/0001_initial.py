# Generated by Django 5.0.7 on 2024-08-15 09:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['patient_id'], name='cdr_exam_patient_31992b_idx')],
            },
        ),
        migrations.AddConstraint(
            model_name='exam',
            constraint=models.UniqueConstraint(fields=('apply_no', 'item_code'), name='unique_apply_no_item_code'),
        ),
        migrations.AddIndex(
