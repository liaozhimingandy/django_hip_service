...
class BloodTransAppInfo(models.Model):
    ...
    apply_no = models.CharField(max_length=36, blank=True, null=True, db_comment='申请单号')
    apply_desc = models.CharField(max_length=255, blank=True, null=True, db_comment='申请单详细信息')
    gmt_apply = models.DateTimeField(blank=True, null=True, db_comment='申请日期时间')
    property = models.CharField(max_length=1, choices=PropertyChoices, default='N', db_comment='优先（紧急）度代码')
    gmt_order = models.DateTimeField(blank=True, null=True, db_comment='开单时间')
    ...
    gmt_review = models.DateTimeField(blank=True, null=True, db_comment='审核日期时间')
    ...
    height = models.CharField(max_length=8, blank=True, null=True, db_comment='患者身高')
    weight = models.CharField(max_length=8, blank=True, null=True, db_comment='患者体重')
    diastolic_pressure = models.CharField(max_length=8, blank=True, null=True, db_comment='患者舒张压')
    temperature = models.CharField(max_length=8, blank=True, null=True, db_comment='患者体温')
    pulse = models.CharField(max_length=8, blank=True, null=True, db_comment='患者脉搏')
    ...
    is_collect = models.BooleanField(default=False, db_comment='采血标记')
    location = models.CharField(max_length=255, blank=True, null=True, db_comment='输血地点')
    purpose = models.CharField(max_length=255, blank=True, null=True, db_comment='输血目的')
    nature = models.CharField(max_length=255, blank=True, null=True, db_comment='输血性质')
    is_urgent = models.BooleanField(default=False, db_comment='输血紧急标志')
    medical = models.CharField(max_length=255, blank=True, null=True, db_comment='病史信息')
    transfusion = models.CharField(max_length=255, blank=True, null=True, db_comment='输血史')
    ...
    gravidity = models.PositiveSmallIntegerField(default=0, db_comment='孕次')
    delivery = models.PositiveSmallIntegerField(default=0, db_comment='产次')
    ...
    blood_unit = models.CharField(max_length=36, blank=True, null=True, db_comment='血量单位')
    blood = models.CharField(max_length=8, blank=True, null=True, db_comment='血量')
    adm_no = models.CharField(max_length=36, db_comment="就诊流水号", verbose_name='就诊流水号', help_text='就诊流水号')
...
class CheckAppInfo(models.Model):
    apply_no = models.CharField(max_length=36, db_comment='检查申请单编号', unique=True)
    ...
    property = models.CharField(max_length=1, choices=PropertyChoices, default='N', db_comment='优先（紧急）度代码')
    gmt_apply = models.DateTimeField(blank=True, null=True, db_comment='开单时间')
    ...
    reviewer = models.CharField(max_length=64, blank=True, null=True, db_comment='审核者姓名')
    order_id = models.CharField(max_length=36, db_comment='医嘱ID', unique=True)
    ...
    gmt_execute = models.DateTimeField(blank=True, null=True, db_comment='执行时间')
...
class CheckAppointStatusInfo(models.Model):
    ...
    adm_cls_code = models.PositiveSmallIntegerField(choices=AdmCodeChoices, db_comment="就诊类别代码",
                                                    verbose_name='就诊类别代码', help_text='就诊类别代码')
    gmt_booking = models.DateTimeField(blank=True, null=True, db_comment='预约检查时间')
    patient_id = models.CharField(max_length=36, db_comment="患者唯一标识ID", verbose_name='患者唯一标识ID',
                                  help_text='患者唯一标识')
    adm_no = models.CharField(max_length=36, db_comment="就诊流水号", verbose_name='就诊流水号', help_text='就诊流水号')
    index = models.PositiveSmallIntegerField(db_comment='预约排序号')
    dept_id = models.CharField(max_length=36, blank=True, null=True, db_comment='病人科室ID')
    ...
    booking_id = models.CharField(db_column='booking_id', max_length=255, blank=True, null=True,
                                  db_comment='预约员工号')
    ...
    execute_dept_name = models.CharField(max_length=64, blank=True, null=True, db_comment='执行科室名称')
    apply_no = models.CharField(max_length=36, db_comment='检查申请单编号')
    order_id = models.CharField(max_length=36, db_comment='医嘱ID')
    from_src = models.CharField(max_length=36, db_comment='来源系统', verbose_name='来源系统', help_text='来源系统')
...
class CheckStatusInfo(models.Model):
    apply_no = models.CharField(max_length=36, db_comment='申请单号')
    gmt_execute = models.DateTimeField(blank=True, null=True, db_comment='操作日期')
    ...
    dept_id = models.CharField(max_length=36, blank=True, null=True, db_comment='操作科室ID')
    dept_name = models.CharField(max_length=64, blank=True, null=True, db_comment='操作科室名称')
    status_code = models.CharField(max_length=8, db_comment='检查状态代码')
    status_name = models.CharField(max_length=64, db_comment='检查状态名称')
    adm_no = models.CharField(max_length=36, db_comment="就诊流水号", verbose_name='就诊流水号', help_text='就诊流水号')
    patient_id = models.CharField(max_length=36, db_comment="患者唯一标识ID", verbose_name='患者唯一标识ID',
                                  help_text='患者唯一标识')
    adm_cls_code = models.PositiveSmallIntegerField(choices=AdmCodeChoices, db_comment="就诊类别代码",
...
class ExamAppInfo(models.Model):
    ...
    property = models.CharField(max_length=1, choices=PropertyChoices, default='N', db_comment='优先（紧急）度代码')
    bar_code = models.CharField(max_length=36, blank=True, null=True, db_comment='条码号')
    ...
    reviewer_id = models.CharField(max_length=36, blank=True, null=True, db_comment='审核者编码')
    reviewer = models.CharField(max_length=64, blank=True, null=True, db_comment='审核者姓名')
    order_id = models.CharField(max_length=36, db_comment='医嘱ID', unique=True, verbose_name='医嘱ID', help_text='医嘱ID')
    item_code = models.CharField(max_length=36, db_comment='检验项目编码')
    item_name = models.CharField(max_length=64, db_comment='检验项目名称')
...
class ExamStatusInfo(models.Model):
    apply_no = models.CharField(max_length=36, db_comment='电子申请单编号')
    apply_desc = models.CharField(max_length=255, blank=True, null=True, db_comment='申请单描述')
    apply_status = models.CharField(max_length=8, blank=True, null=True, db_comment='申请单状态')
    bar_code = models.CharField(max_length=36, db_comment='条码号')
    specimen_cls_code = models.CharField(max_length=8, blank=True, null=True, db_comment='标本类别代码')
    specimen_cls_name = models.CharField(max_length=36, blank=True, null=True, db_comment='标本类别名称')
    gmt_execute = models.DateTimeField(blank=True, null=True, db_comment='操作日期时间')
    status_code = models.CharField(max_length=8, db_comment='操作代码')
    status_name = models.CharField(max_length=36, db_comment='操作名称')
...
class InPatientDischargeInfo(models.Model):
    inpatient_id = models.CharField(max_length=36, db_comment='住院号标识')
    times = models.PositiveIntegerField(db_comment='就诊次数', verbose_name='就诊次数', help_text='就诊次数')
    adm_no = models.CharField(max_length=36, db_comment='就诊流水号', unique=True)
    adm_cls_code = models.PositiveSmallIntegerField(choices=AdmCodeChoices, db_comment="就诊类别代码",
                                                    verbose_name='就诊类别代码', help_text='就诊类别代码')
    gmt_effect_low = models.DateTimeField(blank=True, null=True, db_comment='入院日期时间')
    reason = models.CharField(max_length=255, blank=True, null=True, db_comment='就诊原因描述')
    ins_code = models.CharField(max_length=4, db_comment='医疗保险类别代码')
    in_times = models.PositiveSmallIntegerField(db_comment='住院次数', verbose_name='住院次数', help_text='住院次数')
    patient_id = models.CharField(max_length=36, db_comment="患者唯一标识ID", verbose_name='患者唯一标识ID',
                                  help_text='患者唯一标识')
    ...
    dept_id = models.CharField(max_length=36, blank=True, null=True, db_comment='科室id')
    dept_name = models.CharField(max_length=64, blank=True, null=True, db_comment='科室名称')
    ward_id = models.CharField(max_length=36, blank=True, null=True, db_comment='病区id')
    ward_name = models.CharField(max_length=64, blank=True, null=True, db_comment='病区名称')
    room_id = models.CharField(max_length=36, blank=True, null=True, db_comment='病房id')
    room_name = models.CharField(max_length=64, blank=True, null=True, db_comment='病房名称')
    bed_id = models.CharField(max_length=36, blank=True, null=True, db_comment='床号ID')
    bed_name = models.CharField(max_length=64, blank=True, null=True, db_comment='床号')
    org_code = models.CharField(max_length=18, blank=True, null=True, db_comment='服务机构')
    is_pre_discharge = models.BooleanField(default=False, db_comment='出院登记标识')
    gmt_discharge = models.DateTimeField(blank=True, null=True, db_comment='出院登记时间')
    diags_a = models.JSONField(blank=True, null=True, db_comment='西医诊断')
    diags_b = models.JSONField(blank=True, null=True, db_comment='中医诊断')
    from_src = models.CharField(max_length=36, db_comment='来源系统', verbose_name='来源系统', help_text='来源系统')
...
class OperationAppInfo(models.Model):
    class PropertyChoices(models.IntegerChoices):
        A = (1, '择期')
        B = (2, '围期')
    apply_no = models.CharField(max_length=36, db_comment='申请单号', verbose_name="申请单号", help_text="申请单号", unique=True)
    apply_desc = models.CharField(max_length=255, blank=True, null=True, db_comment='描述/说明')
    gmt_apply = models.DateTimeField(blank=True, null=True, db_comment='申请日期')
    ...
    dept_id = models.CharField(max_length=36, blank=True, null=True, db_comment='申请科室编码')
    dept_name = models.CharField(max_length=64, blank=True, null=True, db_comment='申请科室名称')
    gmt_review = models.DateTimeField(blank=True, null=True, db_comment='审核日期')
    ...
    gmt_booking = models.DateTimeField(blank=True, null=True, db_comment='预订手术时间')
    ...
    execute_dept_id = models.CharField(max_length=36, blank=True, null=True, db_comment='执行科室编码')
    execute_dept_name = models.CharField(max_length=64, blank=True, null=True, db_comment='执行科室名称')
    note = models.CharField(max_length=255, blank=True, null=True, db_comment='注意事项')
    diags = models.JSONField(blank=True, null=True, db_comment='诊断信息', verbose_name='诊断信息',
                             help_text='诊断(手术申请原因)')
    adm_no = models.CharField(max_length=36, db_comment="就诊流水号", verbose_name='就诊流水号', help_text='就诊流水号')
    patient_id = models.CharField(max_length=36, db_comment="患者唯一标识ID", verbose_name='患者唯一标识ID',
...
class OperationScheduleInfo(models.Model):
    booking_id = models.CharField(max_length=36, db_comment='手术排班号', help_text='手术排班号', verbose_name='手术排班号', 
                                  unique=True)
    ...
    room = models.CharField(max_length=36, blank=True, null=True, db_comment='手术间')
    apply_no = models.CharField(max_length=36, db_comment='手术申请单号', verbose_name='手术申请单号', help_text='手术申请单号', 
                                unique=True)
    from_src = models.CharField(max_length=36, db_comment='来源系统', verbose_name='来源系统', help_text='来源系统')
    assistants = models.JSONField(blank=True, null=True, db_comment='助手信息')
...
class OperationStatusInfo(models.Model):
    apply_no = models.CharField(max_length=36, db_comment='申请单号', verbose_name='手术申请单号', help_text='手术申请单号')
    gmt_execute = models.DateTimeField(blank=True, null=True, db_comment='操作日期')
    executor_id = models.CharField(max_length=36, blank=True, null=True, db_comment='操作人工号')
    executor = models.CharField(max_length=64, blank=True, null=True, db_comment='操作人姓名')
    execute_dept_id = models.CharField(max_length=36, blank=True, null=True, db_comment='执行科室编码')
...
class OrderFillerStatusInfo(models.Model):
    ...
    gmt_collect = models.DateTimeField(blank=True, null=True, db_comment='采集日期')
    ...
    execute_status_code = models.CharField(max_length=36, db_comment='医嘱执行状态')
...
class OrderInfo(models.Model):
    ...
    index = models.PositiveIntegerField(db_comment='医嘱序号', verbose_name='医嘱序号', help_text='医嘱序号')
    order_id = models.CharField(db_comment='医嘱ID', verbose_name='医嘱ID', help_text='医嘱ID', unique=True, max_length=36)
    ...
    execute_dept_id = models.CharField(max_length=36, blank=True, null=True, db_comment='执行科室编码')
    execute_dept_name = models.CharField(max_length=64, blank=True, null=True, db_comment='执行科室名称')
    pre_order_id = models.CharField(max_length=64, blank=True, null=True, db_comment='父医嘱ID(没有父医嘱可以没有此occurrenceOf节点)')
    ...
    amount = models.PositiveSmallIntegerField(default=1, db_comment='领量(给药量)')
    amount_unit = models.CharField(max_length=36, blank=True, null=True, db_comment='领量(给药量)-单位')
    gmt_start = models.DateTimeField(blank=True, null=True, db_comment='开始时间')
    gmt_end = models.DateTimeField(blank=True, null=True, db_comment='停止时间')
...
class OrganizationInfo(models.Model):
    dept_id = models.CharField(max_length=36, db_comment='医疗卫生机构（科室）标识-科室', unique=True)
    dept_name = models.CharField(max_length=64, db_comment='医疗卫生机构（科室）实体名称')
    dept_cls_code = models.CharField(max_length=16, db_comment='医疗卫生机构（科室）类别-科室')
    ...
    dept_addr = models.CharField(max_length=255, blank=True, null=True, db_comment='工作地址')
    ...
    from_src = models.CharField(max_length=36, db_comment='来源系统')
...
class OutpatientAppointStatusInfo(models.Model):
    booking_id = models.CharField(max_length=36, db_comment='预约ID', unique=True)
    gmt_schedule = models.DateTimeField(db_comment='预约日期时间')
    patient_id = models.CharField(max_length=36, db_comment="患者唯一标识ID", verbose_name='患者唯一标识ID',
                                  help_text='患者唯一标识')
    id_no = models.CharField(max_length=36, db_comment='身份证号')
    patient_name = models.CharField(max_length=64, db_comment='姓名')
    gmt_booking = models.DateTimeField(db_comment='系统预约日期时间')
    from_src = models.CharField(max_length=36, db_comment='系统id')
    booking_code = models.CharField(max_length=36, db_comment='预约状态代码')
    booking_name = models.CharField(max_length=64, db_comment='预约状态名称')
    gmt_operate = models.DateTimeField(db_comment='医务人员预约日期时间')
    operator_id = models.CharField(max_length=36, db_comment='医务人员工号')
    schedule_id = models.CharField(max_length=36, db_comment='资源ID')
...
class OutPatientInfo(models.Model):
    ...
    adm_no = models.CharField(max_length=36, blank=True, null=True, db_comment='就诊流水号')
    adm_cls_code = models.PositiveSmallIntegerField(choices=AdmCodeChoices, db_comment="就诊类别代码",
                                                    verbose_name='就诊类别代码', help_text='就诊类别代码')
    gmt_adm = models.DateTimeField(blank=True, null=True, db_comment='就诊日期时间')
    reason = models.CharField(max_length=128, blank=True, null=True, db_comment='就诊原因描述')
    ins_cls_code = models.CharField(max_length=2, db_comment='医疗保险类别代码')
    ins_cls_name = models.CharField(max_length=16, db_comment='医疗保险类别名称')
    patient_id = models.CharField(max_length=36, db_comment="患者唯一标识ID", verbose_name='患者唯一标识ID',
                                  help_text='患者唯一标识')
    doc_id = models.CharField(max_length=36, db_comment='医生的职工号')
    doc_name = models.CharField(max_length=16, db_comment='责任医师姓名')
    dept_id = models.CharField(max_length=36, db_comment='服务场所科室标识')
    dept_name = models.CharField(max_length=64, db_comment='服务场所科室')
    org_code = models.CharField(max_length=18, db_comment='服务机构标识')
    from_src = models.CharField(max_length=36, db_comment='来源系统')
    extra = models.JSONField(db_comment='补充信息')
...
class PathologyAppInfo(models.Model):
    apply_no = models.CharField(max_length=36, db_comment='检查申请单编号', unique=True)
    apply_desc = models.CharField(max_length=255, blank=True, null=True, db_comment='申请单详细内容')
    gmt_effect_low = models.DateTimeField(blank=True, null=True, db_comment='检查申请日期')
    class_code = models.CharField(max_length=36, blank=True, null=True, db_comment='检查类型编码')
    ...
    fixation = models.CharField(max_length=64, blank=True, null=True, db_comment='固定液')
    gmt_collect = models.DateTimeField(blank=True, null=True, db_comment='采集日期')
    ...
    dept_id = models.CharField(max_length=36, blank=True, null=True, db_comment='申请科室编码')
    dept_name = models.CharField(max_length=64, blank=True, null=True, db_comment='申请科室名称')
    gmt_review = models.DateTimeField(blank=True, null=True, db_comment='确认时间')
    ...
    item_code = models.CharField(max_length=36, db_comment='检查项目编码')
    item_name = models.CharField(max_length=64, db_comment='检查项目名称')
...
class ProviderInfo(models.Model):
    emp_id = models.CharField(max_length=36, db_comment='医务人员ID', unique=True, verbose_name='医务人员ID', help_text='医务人员ID')
    emp_name = models.CharField(max_length=64, db_comment='姓名')
    job_code = models.CharField(max_length=10, db_comment='专业技术职务代码')
    job_name = models.CharField(max_length=64, db_comment='专业技术职务名称')
    gmt_effect_high = models.DateTimeField(db_comment='角色有效期间开始')
    gmt_effect_low = models.DateTimeField(db_comment='角色有效期间结束')
    id_no = models.CharField(max_length=32, db_comment='身份证号')
    id_code = models.CharField(max_length=2, db_comment='证件号代码')
    id_name = models.CharField(max_length=16, db_comment='证件号名称')
    sex_code = models.PositiveSmallIntegerField(choices=SexCodeChoices, db_comment="性别代码", verbose_name='性别代码',
                                                help_text="性别")
    addr_birth = models.CharField(max_length=255, blank=True, null=True, db_comment='出生地')
    gmt_birth = models.DateField(db_comment='出生日期')
    dept_id = models.CharField(max_length=32, db_comment='科室号标识')
    dept_name = models.CharField(max_length=64, db_comment='科室号名称')
    author_id = models.CharField(max_length=36, db_comment='申请者医务人员ID')
    author = models.CharField(max_length=64, db_comment='申请者医务人员名称')
    author_dept_id = models.CharField(max_length=36, db_comment='申请者科室ID')
    author_dept_name = models.CharField(max_length=64, db_comment='申请者科室名称')
...
class SourceAndScheduleInfo(models.Model):
    schedule_id = models.CharField(max_length=36, db_comment='排班标识', unique=True)
    roster_id = models.CharField(max_length=36, blank=True, null=True, db_comment='操作者ID')
    roster = models.CharField(max_length=64, blank=True, null=True, db_comment='操作者')
    gmt_rostered = models.DateTimeField(blank=True, null=True, db_comment='操作时间')
    ...
    total = models.PositiveIntegerField(db_comment='资源总数', verbose_name='资源总数', help_text='资源总数')
    dept_id = models.CharField(max_length=36, blank=True, null=True, db_comment='科室标识')
    ...
    doc_id = models.CharField(max_length=36, blank=True, null=True, db_comment='出诊医生ID')
    ...
    id_no = models.CharField(max_length=36, blank=True, null=True, db_comment='身份证号')
    ...
    amount = models.PositiveSmallIntegerField(db_comment='分时段资源总数', verbose_name='分时段资源总数' ,help_text='分时段资源总数')
...
class Terminology(models.Model):
    dataset_code = models.CharField(max_length=36, db_comment='值集标识符')
    dataset_name = models.CharField(max_length=64, db_comment='值集描述')
    status = models.BooleanField(default=True, db_comment='值集状态代码; 1: 启用，0：未启用')
    version_no = models.PositiveSmallIntegerField(db_comment='版本号', verbose_name='版本号', help_text='版本号',
                                                  default=1, db_default=1)
    version = models.CharField(max_length=36, db_comment='值集版本信息')
    item_code = models.CharField(max_length=36, db_comment='项目代码')
    item_name = models.CharField(max_length=64, db_comment='项目描述')
...
class TransferInfo(models.Model):
    ...
    in_bed_name = models.CharField(max_length=64, blank=True, null=True, db_comment='转入床号ID')
    ...
    out_bed_name = models.CharField(max_length=64, blank=True, null=True, db_comment='转出床号ID')
    from_src = models.CharField(max_length=36, db_comment='来源系统', verbose_name='来源系统', help_text='来源系统')
